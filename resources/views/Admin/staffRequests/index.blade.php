    ...
    <div class="col-md-6">
        ...
        $(document).ready(function () {
            $('#staffRequestTable').DataTable({
                ...
                serverSide: true,
                pageLength: 25,
                ajax: "{{ route('admin.staffRequests.ajax.getDataTable') }}",
                columns: [
        ...
        $(document).ready(function () {
            ...
            axios.get('{{route('admin.staffRequests.ajax.getRoles')}}')
        ...
        function getRelateUserWithRole() {
            ...
            axios.post('{{route('admin.staffRequests.ajax.getUserWithRole')}}', data)
                .then(function (response) {
                    response.data.forEach(function (item) {
        ...
        document.getElementById('leaveForm').addEventListener('submit', function (event) {
            ...
            axios.post('{{route('admin.staffRequests.ajax.store')}}', data)
                .then(function (response) {
                    location.reload();
                })
                .catch(function (error) {
