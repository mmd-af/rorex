                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="POST" action="">
                                        ...
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="name">{{ __('auth.cod_staff') }}</label>
                                            <input type="number" name="cod_staff" id="cod_staff"
                                                class="form-control form-control-lg" value="{{ old('cod_staff') }}" />
                                        ...
                                        <div class="form-outline mb-4">
                                            <label class="form-label" for="form2Example27">{{ __('auth.password_confirmation') }}</label>
                                        ...
                                        <div class="pt-1 mb-4">
                                            <button class="btn btn-dark btn-lg btn-block" disabled type="submit">{{ __('auth.register') }}</button>
                                        </div>
