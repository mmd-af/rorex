...
@section('content')
    ...
    <div class="d-flex justify-content-between my-3">
        ...
        <div>
            <button type="button"
                    ...
                    data-bs-target="#sendMessageStaffRequest">
    ...
    <div class="modal fade" id="sendMessageStaffRequest" tabindex="-1" aria-labelledby="sendMessageStaffRequestLabel"
         aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="sendMessageStaffRequestLabel">Message</h1>
